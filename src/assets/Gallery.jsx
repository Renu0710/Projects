      ...
      <Container className='mt-5 text-center'>
        ...
        <Row>
          ...
          <Col md={9}>
                    ...
                    <Col key={index}>
                      <Card style={{ width: '20rem' }} className='border-0'>
                        ...
                        <Card.Body>
                          ...
                          {cart.some((c)=>c.id==item.id)?<Button variant='danger' onClick={()=>dispatch({
                            type:"REMOVEFROMCART",
                            payload:item
                          })}>Remove</Button>:<Button variant="primary" disabled={!item.stock} onClick={()=>dispatch({
                            type:"ADDTOCART",
                            payload:item
            ...
            <button variant='dark' className='p-2 px-5 btn1 fs-5 mt-3 mb-5 '>See More</button>
          </Col>
        </Row>
