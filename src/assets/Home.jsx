    ...
    <div>
        ...
        <div className='position-relative'>
            ...
            <div class="position-absolute top-50 start-0  ps-5 translate-middle-y">
                ...
                <Button variant='dark' className='p-3 px-5 btn1'style={{ borderRadius: '0' }}>LEARN MORE</Button>
            </div>
        </div>
        </Container >
        <About/>
        ...
        <Services/>
        <Container>
          <h1 className=' fw-bolder'style={{color: "#fd7e14"}}>Testimonial</h1>
      ...
      <Carousel.Item className='border-start border-end border-dark border-2 p-3 bracket-border'>
        <h3 className='fw-bold' style={{color: "#fd7e14"}}>MONILA<span className='ms-4'><img src='./images/quick-icon.png' alt=''/></span></h3>
